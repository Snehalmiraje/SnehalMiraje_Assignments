...
public class streamApiDemo {
	public static void main(String[] args) {
		...
		flist.add(new Fruit ("graps",65,100,"green"));
		flist.add(new Fruit ("strawberry",77,200,"red"));
		
		ArrayList<news> nlist= new ArrayList<>();
		nlist.add(new news(1,"snehal","sachin","Good"));
		nlist.add(new news(1,"abhi","sachin","Great explained"));
		nlist.add(new news(2,"pratiksha","neha","nice one"));
		nlist.add(new news(3,"pratiksha","nehal","nice budget"));

		
		ArrayList<trader> tlist= new ArrayList<>();
		trader t1=new trader("pushpa","indore");
		trader	t2=new trader("parth","delhi");
		trader t3=new trader("ravina","pune");
		...
		ArrayList<trasaction> tclist= new ArrayList<>();
		tclist.add(new trasaction (1999,1000,t1));
		tclist.add(new trasaction (2000,1500,t2));
		tclist.add(new trasaction (2015,1200,t3));
		tclist.add(new trasaction (2011,2002,t4));
		tclist.add(new trasaction (2011,2000,t4));
		tclist.add(new trasaction (2011,2005,t4));
